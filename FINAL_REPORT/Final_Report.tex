...
skin cancer in the US every hour\textsuperscript{\hyperlink{[1]}{[1]}}. Early detection is key in
saving lives, with the early detection 5 year survival rate fo skin
cancer being 99\%\textsuperscript{\hyperlink{[1]}{[1]}}. Dermatologist have to look at patients one by
...
then dermatologist's, around 72.1\%\textsuperscript{\hyperlink{[2]}{[2]}}.
...
\begin{figure}
  \includegraphics[width=12.5cm]{images/eff_net_base_roc.png}
...
\hypertarget{[9]}{[9] {[}9{]}SIIM-ISIC Melanoma Classification. (2020). Retrieved July 20,
